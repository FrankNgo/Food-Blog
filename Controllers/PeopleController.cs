...
namespace FoodBlog.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public PeopleController(FoodBlogDbContext context)
        {
            _context = context;    
        }
        ...
        {
            var foodBlogDbContext = _context.People.Include(p => p.Experience);
        ...
        {
            ViewData["ExperienceId"] = new SelectList(_context.Experiences, "ExperienceId", "Title");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonId,Name,Desc,ExperienceId")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonId,Name,Desc,ExperienceId")] Person person)
        {
